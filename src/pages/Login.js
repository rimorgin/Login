...
useEffect(() => {
  setTimeout(() => {
    ...
    try {
      ...
      } else if (loggedInUserUID === 'VlelbuWHavZFdbkVBjoM3dSxRDs1') {
        setPreload(true); 
        setAdminState(false);
        dispatch(LoginUser({user: loggedInUserName, uid: loggedInUserUID, email: loggedInUserEmail, isAdmin: false, isZLeader: true, inSession: true}));
        console.log(dispatch(LoginUser({user: loggedInUserName,uid: loggedInUserUID, email: loggedInUserEmail, isAdmin: false, isZLeader: true, inSession: true})))
        navigate('/ZoneLeader-dashboard');
      } else {
        setPreload(true); 
        setAdminState(false);
        dispatch(LoginUser({user: loggedInUserName, uid: loggedInUserUID, email: loggedInUserEmail, isAdmin: false, isZLeader: false, inSession: true}));
        //console.log(dispatch(LoginUser({user: loggedInUserName,uid: loggedInUserUID, email: loggedInUserEmail, isAdmin: false, inSession: true})))
        navigate('/dashboard')
      }      
      ...
      <><HomeNavBar/><main>
          <section>
            <div className={classes.container}>
              <h1 className={classes.h1text}>Hi, Welcome!</h1>
              <h4 className={classes.h1text2}>Enter your credentials to continue</h4>
