...
useEffect(() => {
  setTimeout(() => {
    ...
    try {
      ...
      if (loggedInUserUID === 'VlelbuWHavZFdbkVBjoM3dSxRDs1') {
        setPreload(true); 
        setAdminState(false);
      ...
      <><HomeNavBar/><main>
          <section>
            <div className={classes.container}>
              <h1 className={classes.h1text}>Hi, Welcome Back ZoneLeader!</h1>
...
export default ZoneLeaderLogin;
