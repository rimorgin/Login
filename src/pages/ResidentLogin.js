...
useEffect(() => {
  setTimeout(() => {
    ...
    try {
      ...
      if (loggedInUserUID !== '133a9K4Q3KNh4iD93OrT5ZAZIAW2' || loggedInUserUID !== 'grNkxp7iKKhEgh1jmcJ3CqJRJ1E3' || loggedInUserUID !== '7gTgmve5osQFe1IgOKVw7yO2nsW2' || loggedInUserUID !== 'VlelbuWHavZFdbkVBjoM3dSxRDs1') {
        setPreload(true); 
        setAdminState(false);
      ...
      <><HomeNavBar/><main>
          <section>
            <div className={classes.container}>
              <h1 className={classes.h1text}>Hi, Welcome Back User!</h1>
              <h4 className={classes.h1text2}>Enter your User Rredentials to continue</h4>
